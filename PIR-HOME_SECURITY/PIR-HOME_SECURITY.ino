...
//*********************** PIR Motion Sensor Setup *****************************                                                        
                                           ...
                                           // choose the pin for the LED (Pin D5, GPIO 14) I tried using pin D4 but had problems for some reason
...
#define WLAN_SSID       "Somesh's Galaxy M51"                        // Enter Your router SSID
#define WLAN_PASS       "qwerty1234"                        // Enter Your router Password

//************************* Adafruit.io Setup *********************************

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                              // use 8883 for SSL
#define AIO_USERNAME    "Tangent_12211"                      // Enter Your Adafruit IO Username
#define AIO_KEY         "aio_Bujy549zTifhvF8eON1YxEDGqcaJ"                      // Enter Your Adafruit IO Key
...
//const char motion_FEED[] PROGMEM = AIO_USERNAME "Tangent_12211/";
...
void setup() 
{
  ...
  pinMode(LED_BUILTIN, OUTPUT);                                // declare LED for motion sensor as output
  pinMode(inputPin, INPUT);                               // declare Motion sensor pin as input

  Serial.begin(9600);
  Serial.println();//to print in serial monitor
